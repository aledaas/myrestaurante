...
public class AdapterHelp extends RecyclerView.Adapter<AdapterHelp.MyViewHolder> implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(v -> listener.onItemSelected(productListFiltered.get(getAdapterPosition())));
        }
    }

    public AdapterHelp(Context context, List<Help> productList, onItemClickListener listener) {
